...
const CartCounter = ({ isZeroDelete, onAdd, onRemove, className, initialValue = 1 }: CartCounterProps) => {
  ...
  return (
    ...
    >
      ...
      <span className="font-medium text-sm sm:text-base">{!isZeroDelete ? counter : initialValue}</span>
      <Button
        variant="ghost"
        size="icon"
        type="button"
