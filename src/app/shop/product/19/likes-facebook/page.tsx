...
export default function LikesFacebookPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = likesOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    if (!postLink) {
      alert("Por favor ingresa el link de la publicación de Facebook")
      return
    }
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Likes Facebook" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              <Image
                src="/images/facebook-3d-logo.png"
                width={400}
                height={400}
                alt="Likes Facebook"
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaHeart className="text-blue-600 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Likes Facebook</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.7} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.7 <span className="text-black/60">(68 reseñas)</span>
              </span>
            </div>
              ...
              <div>
                ...
                <InputGroup className="bg-[#F0F0F0]">
                  <InputGroup.Input
                    type="text"
                    name="post-link"
                    placeholder="https://www.facebook.com/usuario/posts/XXXXXXXX"
                    value={postLink}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Likes Facebook</h3>
              <p className="text-black/70 mb-4">
                Aumenta los likes de tus publicaciones en Facebook con nuestro servicio premium. Mejora el engagement de
                tus publicaciones y haz que tu contenido sea más atractivo para el algoritmo.
              </p>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">¿Por qué aumentar tus likes?</h3>

              <div className="border border-blue-500/20 rounded-xl p-5 bg-blue-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mayor visibilidad en el algoritmo de Facebook</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Aumenta las posibilidades de aparecer en el feed de más usuarios</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Genera mayor credibilidad para tu contenido</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
