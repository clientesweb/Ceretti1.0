...
const likesOptions = [
  { value: "100", label: "100 Likes", price: 600 },
  { value: "500", label: "500 Likes", price: 2000 },
]
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Likes TikTok" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Likes TikTok</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.7} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.7 <span className="text-black/60">(56 reseñas)</span>
              </span>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Likes TikTok</h3>
              <p className="text-black/70 mb-4">
                Aumenta los likes de tus videos en TikTok con nuestro servicio premium. Mejora el engagement de tus
                videos y haz que tu contenido sea más atractivo para el algoritmo.
              </p>
