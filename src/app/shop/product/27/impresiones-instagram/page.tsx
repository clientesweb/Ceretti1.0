...
// Definir las opciones de cantidad y precios para impresiones
const impresionesOptions = [
  { value: "250", label: "250 Impresiones", price: 400 },
  { value: "500", label: "500 Impresiones", price: 800 },
  { value: "1000", label: "1.000 Impresiones", price: 1500 },
  { value: "2500", label: "2.500 Impresiones", price: 3500 },
  { value: "5000", label: "5.000 Impresiones", price: 6000 },
]

export default function ImpresionesInstagramPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = impresionesOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 27,
        name: `Impresiones Instagram - ${quantity}`,
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Impresiones para Posteos Instagram" />
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              <Image
                ...
                width={400}
                height={400}
                alt="Impresiones para Posteos Instagram"
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaChartLine className="text-green-500 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Impresiones para Posteos Instagram</h3>
              <p className="text-black/70 mb-4">
                Aumenta las impresiones de tus publicaciones en Instagram con nuestro servicio premium. Las impresiones
                son una métrica clave para el algoritmo de Instagram y pueden ayudar a mejorar el alcance y la
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">¿Por qué son importantes las impresiones?</h3>

              <div className="border border-green-500/20 rounded-xl p-5 bg-green-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Las impresiones muestran cuántas veces se ha mostrado tu publicación</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>El algoritmo de Instagram prioriza el contenido con más impresiones</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mejora las estadísticas generales de tu cuenta</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
