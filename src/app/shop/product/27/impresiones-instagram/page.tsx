...
export default function ImpresionesInstagramPage() {
  ...
  const quantityOptions: QuantityOption[] = [
    { value: "250", label: "250 impresiones", price: 400, bonus: "" },
    { value: "500", label: "500 impresiones", price: 800, bonus: "" },
    { value: "1000", label: "1.000 impresiones", price: 1500, bonus: "" },
    { value: "2500", label: "2.500 impresiones", price: 3500, bonus: "" },
    { value: "5000", label: "5.000 impresiones", price: 6000, bonus: "" },
  ]
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Impresiones Instagram ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Impresiones Instagram" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Impresiones Instagram</h1>
              <div className="flex items-center gap-2 mb-4">
                <span className="px-2 py-1 bg-ceretti-blue/10 text-ceretti-blue rounded-full text-xs font-medium">
                  instagram
                </span>
              </div>
              <p className="text-black/70">Aumenta las impresiones de tus publicaciones y mejora tu alcance.</p>
            </div>
