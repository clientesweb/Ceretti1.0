          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <Tabs defaultValue="mundial" value={geoType} onValueChange={setGeoType} className="w-full">
                  <TabsList className="grid grid-cols-2 mb-2">
                    <TabsTrigger value="mundial">Mundial</TabsTrigger>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="public-profile">El perfil está público</Label>
              </div>
            </div>
