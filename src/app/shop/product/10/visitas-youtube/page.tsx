...
export default function VisitasYoutubePage() {
  ...
  const [bonus, setBonus] = useState<string>("Retención 1 a 3 minutos")
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 10,
        name: `Visitas YouTube ${geoType === "calidad" ? "Calidad" : "Mundial"} - ${quantity}`,
        srcUrl: "/images/youtube-3d-logo.png",
        price: price,
        attributes: [geoType, quantity, videoLink, bonus],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Visitas YouTube" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaEye className="text-red-600 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Visitas YouTube</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.8} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.8 <span className="text-black/60">(92 reseñas)</span>
              </span>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="mt-2 bg-red-600/10 text-red-600 px-3 py-1.5 rounded-full inline-block text-sm font-medium">
                {bonus}
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-black/60 mt-2">
                  {geoType === "mundial"
                    ? "Visitas de todo el mundo con retención de 1 a 3 minutos. Entrega más rápida y económica."
                    : "Visitas de mayor calidad con retención de 2 a 5 minutos. Mayor impacto en el algoritmo."}
                </p>
              </div>
                ...
                >
                  {(geoType === "calidad" ? calidadOptions : mundialOptions).map((option) => (
                    <option key={option.value} value={option.value}>
                      👁️ {option.label} = {option.price}💲 {option.bonus.includes("🎁") && option.bonus}
                    </option>
                  ))}
                </select>
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Visitas YouTube con Retención</h3>
              <p className="text-black/70 mb-4">
                Aumenta las visualizaciones de tus videos de YouTube con nuestro servicio de visitas con retención.
                Mejora la visibilidad de tus videos y haz que tu contenido llegue a más personas gracias al algoritmo.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border border-black/10 rounded-xl p-4">
                  ...
                  <ul className="space-y-2 text-sm text-black/70">
                    <li>✓ Visitas internacionales</li>
                    <li>✓ Retención de 1 a 3 minutos</li>
                ...
                <div className="border border-ceretti-blue/20 rounded-xl p-4 bg-ceretti-blue/5">
                  ...
                  <ul className="space-y-2 text-sm text-black/70">
                    <li>✓ Retención de 2 a 5 minutos</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Las visitas con retención mejoran significativamente el posicionamiento de tus videos en los resultados
                de búsqueda.
              </p>
            </div>
            ...
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Un video con más visualizaciones genera mayor confianza y atrae a nuevos espectadores de forma orgánica.
              </p>
            </div>
            ...
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Más visualizaciones significan mayores ingresos por publicidad en tus videos monetizados.
              </p>
            </div>
          </div>
        </div>
