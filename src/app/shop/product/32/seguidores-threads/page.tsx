...
export default function SeguidoresThreadsPage() {
  ...
  const quantityOptions: QuantityOption[] = [
    { value: "50", label: "50 seguidores", price: 800, bonus: "" },
    { value: "100", label: "100 seguidores", price: 1500, bonus: "" },
    { value: "250", label: "250 seguidores", price: 3000, bonus: "" },
    { value: "500", label: "500 seguidores", price: 5000, bonus: "" },
    { value: "1000", label: "1.000 seguidores", price: 8500, bonus: "" },
  ]
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Seguidores Threads ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Seguidores Threads</h1>
              ...
              <p className="text-black/70">
                Incrementa tus seguidores en Threads y mejora tu credibilidad. Calidad mundial.
              </p>
            </div>
