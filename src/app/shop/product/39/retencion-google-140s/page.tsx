...
export default function RetencionGoogle140sPage() {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 39,
        name: `Retención Google 140s - ${quantity}`,
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Retención Google 140s" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Retención Google 140s</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={5} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                5.0 <span className="text-black/60">(45 reseñas)</span>
              </span>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                <label className="block text-base font-medium mb-2">
                  Duración del video <span className="text-red-500">*</span>
                </label>
                <InputGroup className="bg-[#F0F0F0]">
                  <InputGroup.Input
                    type="text"
                    name="video-duration"
                    placeholder="Ej: 3:45 (minutos:segundos)"
                    value={videoDuration}
                    onChange={(e) => setVideoDuration(e.target.value)}
                    className="bg-transparent placeholder:text-black/40"
                  />
                </InputGroup>
                <p className="text-xs text-black/60 mt-1">El video debe tener una duración mínima de 2:30 minutos</p>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="fast">Rápida (3-4 días) +20%</option>
                </select>
              </div>

              {/* Checkbox video público */}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Retención Google 140s</h3>
              <p className="text-black/70 mb-4">
                Maximiza el rendimiento de tus videos con visualizaciones de alta retención (140 segundos). Este
                servicio premium optimiza significativamente tus métricas en YouTube, mejorando drásticamente el
                posicionamiento de tu contenido en el algoritmo.
              </p>
              ...
              <ul className="space-y-2 text-black/70">
                ...
                <li className="flex items-start">
                  <FaCheck className="text-green-500 mt-1 mr-2" /> Soporte prioritario 24/7
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="border border-black/10 rounded-xl p-4 mb-4">
                <ul className="space-y-2 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mejora significativa en el algoritmo de YouTube
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Aumento superior de la tasa de retención (140
                    segundos)
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mayor visibilidad en resultados de búsqueda y
                    recomendaciones
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Incremento notable en la credibilidad del canal
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Potencial aumento de suscriptores y engagement
                    orgánico
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mejor posicionamiento para monetización
                  </li>
                </ul>
              </div>

              <p className="text-sm text-black/70">
                <strong>Nota:</strong> Para obtener los mejores resultados, asegúrate de que tu video esté público,
                tenga una duración mínima de 2:30 minutos y cumpla con las políticas de YouTube.
              </p>
            </div>
          </div>
        </div>
