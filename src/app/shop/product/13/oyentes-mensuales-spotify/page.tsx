...
export default function OyentesMensualesSpotifyPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = oyentesOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 13,
        name: `Oyentes Mensuales Spotify - ${quantity}`,
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Oyentes Mensuales Spotify" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaHeadphones className="text-green-500 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Oyentes Mensuales Spotify</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.9} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.9 <span className="text-black/60">(68 reseñas)</span>
              </span>
            </div>
              ...
              <div>
                ...
                <InputGroup className="bg-[#F0F0F0]">
                  <InputGroup.Input
                    type="text"
                    name="profile-link"
                    placeholder="https://open.spotify.com/artist/XXXXXXXX"
                    value={profileLink}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Oyentes Mensuales Spotify</h3>
              <p className="text-black/70 mb-4">
                Aumenta tus oyentes mensuales en Spotify con nuestro servicio premium. Esta métrica es crucial para
                artistas que buscan mejorar su posicionamiento y credibilidad en la plataforma.
              </p>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">¿Por qué aumentar tus oyentes mensuales?</h3>

              <div className="border border-green-500/20 rounded-xl p-5 bg-green-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Es la métrica más importante para sellos discográficos y promotores</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mejora significativamente tu posicionamiento en el algoritmo</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Genera mayor credibilidad como artista</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Más oyentes mensuales abren puertas a colaboraciones, patrocinios y oportunidades profesionales.
              </p>
            </div>
          </div>
        </div>
