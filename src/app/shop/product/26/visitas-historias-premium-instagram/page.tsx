...
export default function VisitasHistoriasPremiumInstagramPage() {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 26,
        name: `Visitas Historias Premium Instagram - ${quantity}`,
        srcUrl: "/images/instagram-3d-logo.png",
        price: price,
        attributes: [quantity, profileLink, isPublic ? "Público" : "Privado"],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Visitas Historias Premium Instagram" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <Image
              ...
              width={400}
              height={400}
              alt="Visitas Historias Premium Instagram"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Visitas Historias Premium Instagram</h3>
              <p className="text-black/70 mb-4">
                Aumenta la visibilidad de tus historias de Instagram con visitas de alta calidad. Nuestro servicio
                premium garantiza visitas reales que mejoran tu alcance y credibilidad en la plataforma.
              </p>
            ...
            <div>
              ...
              <div className="border border-black/10 rounded-xl p-4 mb-4">
                <ul className="space-y-2 text-black/70">
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Aumento del alcance de tus publicaciones
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mejora en la credibilidad de tu perfil
                  </li>
                  <li className="flex items-start">
              ...
              <p className="text-sm text-black/70">
                ...
                que publiques historias regularmente.
              </p>
            </div>
          </div>
        </div>
