...
// Definir las opciones de cantidad y precios para visitas a historias activas
const visitasHistoriasActivasOptions = [
  { value: "100", label: "100 Visitas", price: 550 },
  { value: "250", label: "250 Visitas", price: 1500 },
  { value: "500", label: "500 Visitas", price: 2500 },
  { value: "1000", label: "1.000 Visitas", price: 4500 },
  { value: "2500", label: "2.500 Visitas", price: 10000 },
  { value: "5000", label: "5.000 Visitas", price: 18000 },
]
...
export default function VisitasHistoriasActivasInstagramPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = visitasHistoriasActivasOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 26,
        name: `Visitas Historias Activas Instagram - ${quantity}`,
        srcUrl: "/images/instagram-3d-logo.png",
        price: price,
        attributes: [quantity, username, "Todas las activas"],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Visitas para Todas las Historias Activas Instagram" />
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              <Image
                ...
                width={400}
                height={400}
                alt="Visitas para Todas las Historias Activas Instagram"
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="mt-2 bg-yellow-100 text-yellow-800 px-3 py-1.5 rounded-full inline-block text-sm font-medium">
                Todas las historias activas / Cuentas Mundiales
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                >
                  {visitasHistoriasActivasOptions.map((option) => (
              ...
              <div>
                <label className="block text-base font-medium mb-2">
                  ...
                  <span className="text-black/60">(sin @)</span>
                </label>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Visitas para Todas las Historias Activas</h3>
              <p className="text-black/70 mb-4">
                Aumenta las visualizaciones de todas tus historias activas de Instagram con nuestro servicio premium. A
                diferencia de otros servicios que solo añaden visitas a una historia específica, este servicio añade
                visitas a todas tus historias activas en ese momento.
              </p>
              ...
              <div className="border border-ceretti-blue/20 rounded-xl p-5 bg-ceretti-blue/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    ...
                    <span>Aumenta la visibilidad de todas tus historias activas</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mejora tu posicionamiento en el algoritmo de Instagram</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Ahorra tiempo al no tener que comprar visitas para cada historia individualmente</span>
                  </li>
                </ul>
              </div>
            </div>
