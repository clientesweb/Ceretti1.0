...
export default function CompartidosPosteosInstagram() {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 30,
        name: `Compartidos Posteos Instagram - ${quantity}`,
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Compartidos Posteos Instagram" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <Image
              ...
              width={400}
              height={400}
              alt="Compartidos Posteos Instagram"
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Compartidos Posteos Instagram</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={5} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.8 <span className="text-black/60">(68 reseñas)</span>
              </span>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Compartidos Posteos Instagram</h3>
            ...
            <div>
              ...
              <div className="border border-black/10 rounded-xl p-4 mb-4">
                <ul className="space-y-2 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mayor alcance para tus publicaciones
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mayor probabilidad de llegar a nuevas audiencias
                  </li>
                  <li className="flex items-start">
