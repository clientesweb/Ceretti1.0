...
// Definir las opciones de cantidad y precios para compartidos
const compartidosOptions = [
  { value: "100", label: "100 Compartidos", price: 350 },
  { value: "250", label: "250 Compartidos", price: 800 },
  { value: "500", label: "500 Compartidos", price: 1500 },
  { value: "1000", label: "1.000 Compartidos", price: 2500 },
  { value: "2500", label: "2.500 Compartidos", price: 4500 },
  { value: "5000", label: "5.000 Compartidos", price: 8000 },
]

export default function CompartidosInstagramPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = compartidosOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        id: 30,
        name: `Compartidos Instagram - ${quantity}`,
        srcUrl: "/images/instagram-3d-logo.png",
        price: price,
        attributes: [quantity, username || postLink],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Compartidos para Posteos Instagram" />
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              <Image
                ...
                width={400}
                height={400}
                alt="Compartidos para Posteos Instagram"
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaShare className="text-pink-500 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Compartidos para Posteos Instagram</h3>
              <p className="text-black/70 mb-4">
                Aumenta el alcance de tus publicaciones de Instagram con nuestro servicio de compartidos. Este servicio
                incrementa el número de veces que tu contenido es compartido, mejorando su visibilidad y alcance
                orgánico.
              </p>
              ...
              <ul className="space-y-2 text-black/70">
                ...
                <li className="flex items-start">
                  <FaCheck className="text-green-500 mt-1 mr-2" /> Cuentas reales
                </li>
                <li className="flex items-start">
              ...
              <div className="border border-pink-500/20 rounded-xl p-5 bg-pink-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    ...
                    <span>Aumenta el alcance de tus publicaciones</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mejora la visibilidad de tu contenido</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Incrementa la posibilidad de llegar a nuevas audiencias</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Potencia el engagement general de tu cuenta</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mejora la percepción de popularidad de tu contenido</span>
                  </li>
                </ul>
              </div>
            </div>
