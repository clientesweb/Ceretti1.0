...
export default function CompartidosInstagramPage() {
  ...
  const quantityOptions: QuantityOption[] = [
    { value: "100", label: "100 compartidos", price: 350, bonus: "" },
    { value: "250", label: "250 compartidos", price: 800, bonus: "" },
    { value: "500", label: "500 compartidos", price: 1500, bonus: "" },
    { value: "1000", label: "1.000 compartidos", price: 2500, bonus: "" },
    { value: "2500", label: "2.500 compartidos", price: 4500, bonus: "" },
    { value: "5000", label: "5.000 compartidos", price: 8000, bonus: "" },
  ]
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Compartidos Instagram ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Compartidos Instagram" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Compartidos Instagram</h1>
              <div className="flex items-center gap-2 mb-4">
                <span className="px-2 py-1 bg-ceretti-blue/10 text-ceretti-blue rounded-full text-xs font-medium">
                  instagram
                </span>
              </div>
              <p className="text-black/70">Aumenta los compartidos de tus publicaciones y mejora tu alcance.</p>
            </div>
