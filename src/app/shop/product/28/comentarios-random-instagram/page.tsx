...
export default function ComentariosRandomInstagramPage() {
  ...
  const quantityOptions: QuantityOption[] = [
    { value: "10", label: "10 comentarios", price: 2000, bonus: "" },
    { value: "50", label: "50 comentarios", price: 4500, bonus: "" },
    { value: "100", label: "100 comentarios", price: 7500, bonus: "" },
    { value: "500", label: "500 comentarios", price: 15000, bonus: "" },
    { value: "1000", label: "1.000 comentarios", price: 25000, bonus: "" },
  ]
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      dispatch(
        addToCart({
          id: 28,
          name: "Comentarios Random Instagram",
      ...
      toast({
        ...
        description: "Comentarios Random Instagram ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Comentarios Random Instagram</h1>
              ...
              <p className="text-black/70">
                Aumenta el engagement con comentarios aleatorios en tus publicaciones. Pueden ser emojis o cualquier
                otro tipo de comentario con cuentas mundiales.
              </p>
            </div>
