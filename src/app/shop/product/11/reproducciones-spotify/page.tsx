...
const reproduccionesOptions = [
  { value: "500", label: "500 Reproducciones", price: 3500 },
  { value: "1000", label: "1.000 Reproducciones", price: 5000 },
  { value: "2500", label: "2.500 Reproducciones", price: 10000 },
  { value: "5000", label: "5.000 Reproducciones", price: 17500 },
  { value: "10000", label: "10.000 Reproducciones", price: 31000 },
]
...
export default function ReproduccionesSpotifyPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = reproduccionesOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    if (!trackLink) {
      alert("Por favor ingresa el link de la canción de Spotify")
      return
    }
    ...
    dispatch(
      addToCart({
        id: 11,
        name: `Reproducciones Spotify - ${quantity}`,
        srcUrl: "/images/spotify-3d-logo.png",
        price: price,
        attributes: [quantity, trackLink],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Reproducciones Spotify" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaPlay className="text-green-500 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Reproducciones Spotify</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.7} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.7 <span className="text-black/60">(83 reseñas)</span>
              </span>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                >
                  {reproduccionesOptions.map((option) => (
              ...
              <div>
                <label className="block text-base font-medium mb-2">
                  Link de la canción <span className="text-red-500">*</span>
                </label>
                ...
                <p className="text-xs text-black/60 mt-1">Asegúrate de que la canción sea pública</p>
              </div>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Reproducciones Spotify</h3>
              <p className="text-black/70 mb-4">
                Aumenta las reproducciones de tus canciones en Spotify con nuestro servicio premium. Mejora la
                visibilidad de tu música y haz que tus canciones lleguen a más personas gracias al algoritmo.
              </p>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">¿Por qué aumentar tus reproducciones?</h3>

              <div className="border border-green-500/20 rounded-xl p-5 bg-green-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Mayor visibilidad en las listas de reproducción de Spotify</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Aumenta tus posibilidades de ser incluido en playlists populares</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Incrementa tus ingresos por reproducciones</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Genera mayor credibilidad para sellos discográficos y promotores</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Aumenta la visibilidad de tus canciones en Spotify y mejora tus posibilidades de ser descubierto.
              </p>
            </div>
            ...
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Una canción con más reproducciones genera mayor confianza y atrae a nuevos oyentes de forma orgánica.
              </p>
            </div>
            ...
            <div className="bg-white border border-black/10 rounded-xl p-5">
              ...
              <p className="text-black/70">
                Más reproducciones significan mayores ingresos por streaming en tu cuenta de Spotify.
              </p>
            </div>
          </div>
        </div>
