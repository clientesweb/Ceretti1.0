  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Reacción Historia Quiz Instagram ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Reacción Historia Quiz Instagram" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-[#F8F9FB] rounded-2xl p-6 flex items-center justify-center">
            <div className="relative w-full max-w-[300px] aspect-square">
              <Image
                ...
                alt="Reacción Historia Quiz Instagram"
                fill
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Reacción Historia Quiz Instagram</h1>
              ...
              <p className="text-black/70">
                Aumenta las reacciones a tus encuestas en historias con cuentas mundiales. Solo disponible para opción
                A.
              </p>
            </div>
