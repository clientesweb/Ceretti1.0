...
import { FaCheck, FaPoll } from "react-icons/fa"
import { addToCart } from "@/lib/features/carts/cartsSlice"
import { useAppDispatch } from "@/lib/hooks/redux"
import Image from "next/image"
import InputGroup from "@/components/ui/input-group"

// Definir las opciones de cantidad y precios para reacciones a Quiz
const reaccionesQuizOptions = [
  { value: "100", label: "100 Reacciones", price: 250 },
  { value: "250", label: "250 Reacciones", price: 600 },
  { value: "500", label: "500 Reacciones", price: 1000 },
  { value: "1000", label: "1.000 Reacciones", price: 1800 },
  { value: "2500", label: "2.500 Reacciones", price: 4000 },
  { value: "5000", label: "5.000 Reacciones", price: 7000 },
]

export default function ReaccionHistoriaQuizInstagramPage() {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedOption = reaccionesQuizOptions.find((opt) => opt.value === selectedValue)
    if (selectedOption) {
  ...
  const handleAddToCart = () => {
    ...
    dispatch(
      addToCart({
        ...
        price: price,
        attributes: [quantity, username || storyLink, "Opción A"],
        discount: {
          amount: 0,
          percentage: 0,
        },
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Reacciones Quiz para Historias Instagram" />
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              <Image
                ...
                width={400}
                height={400}
                alt="Reacciones Quiz para Historias Instagram"
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaPoll className="text-purple-500 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="mt-2 bg-yellow-100 text-yellow-800 px-3 py-1.5 rounded-full inline-block text-sm font-medium">
                Solo opción A / Cuentas Mundiales
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                >
                  {reaccionesQuizOptions.map((option) => (
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Reacciones Quiz para Historias Instagram</h3>
              <p className="text-black/70 mb-4">
                Aumenta la interacción en tus historias de Instagram con nuestro servicio de reacciones para encuestas
                tipo Quiz. Este servicio añade votos a la opción A de tus encuestas, mejorando el engagement y la
                visibilidad de tus historias.
              </p>
              ...
              <div className="border border-purple-500/20 rounded-xl p-5 bg-purple-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    ...
                    <span>Aumenta la participación en tus encuestas</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
