...
export default function BarraReaccionInstagramPage() {
  ...
  const quantityOptions: QuantityOption[] = [
    { value: "100", label: "100 reacciones", price: 400, bonus: "" },
    { value: "250", label: "250 reacciones", price: 1000, bonus: "" },
    { value: "500", label: "500 reacciones", price: 1500, bonus: "" },
    { value: "1000", label: "1.000 reacciones", price: 2500, bonus: "" },
    { value: "2500", label: "2.500 reacciones", price: 4500, bonus: "" },
    { value: "5000", label: "5.000 reacciones", price: 8000, bonus: "" },
  ]
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Barra de Reacción Instagram ha sido añadido al carrito",
      })
      setLoading(false)
    }, 1000)
  }
      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Barra de Reacción Instagram</h1>
              ...
              <p className="text-black/70">
                Aumenta las reacciones a tus barras en historias con cuentas mundiales. Reacciones 0-100 aleatorias.
              </p>
            </div>
