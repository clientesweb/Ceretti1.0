...
export default function BarraReaccionInstagramPage() {
  ...
  const handleAddToCart = () => {
    if (!storyLink) {
      alert("Por favor ingresa el link de tu historia de Instagram con la barra de reacción")
      return
    }
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Barra de Reacción Instagram" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <Image
              ...
              width={400}
              height={400}
              alt="Barra de Reacción Instagram"
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Barra de Reacción Instagram</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={5} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                5.0 <span className="text-black/60">(87 reseñas)</span>
              </span>
            </div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                <label className="block text-base font-medium mb-2">
                  Link de la historia con barra de reacción <span className="text-red-500">*</span>
                </label>
            ...
            <div className="mb-6 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Nota:</strong> 0-100 Random/Cuentas Mundiales
              </p>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Barra de Reacción Instagram</h3>
              <p className="text-black/70 mb-4">
                Incrementa la interacción en tus barras de reacción de Instagram con participaciones reales. Este
                servicio aumenta la visibilidad de tus historias y mejora tu engagement.
              </p>
            ...
            <div>
              ...
              <div className="border border-black/10 rounded-xl p-4 mb-4">
                <ul className="space-y-2 text-black/70">
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Mayor interacción en tus historias
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2" /> Aumento de la participación de tu audiencia
                  </li>
                  <li className="flex items-start">
              ...
              <p className="text-sm text-black/70">
                ...
                que la historia con la barra de reacción esté activa durante al menos 24 horas.
              </p>
            </div>
          </div>
        </div>
