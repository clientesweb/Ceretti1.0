...
const seguidoresOptions = [
  ...
  { value: "10000", label: "10.000 Seguidores", price: 80000 },
]

export default function SeguidoresFacebookPage() {
  ...
  const handleAddToCart = () => {
    if (!profileLink) {
      alert("Por favor ingresa el link de tu perfil de Facebook")
      return
    }
    ...
    dispatch(
      addToCart({
        id: 18,
        name: `Seguidores Facebook - ${quantity}`,
  ...
  return (
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        <BreadcrumbProduct title="Seguidores Facebook" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#F0EEED] rounded-[20px] overflow-hidden flex items-center justify-center p-8">
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-3 rounded-full">
                <FaUsers className="text-blue-600 text-3xl animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className={cn([integralCF.className, "text-3xl md:text-4xl mb-3"])}>Seguidores Facebook</h1>

            <div className="flex items-center mb-4">
              <Rating initialValue={4.8} SVGclassName="inline-block" emptyClassName="fill-gray-50" size={24} readonly />
              <span className="text-black text-sm ml-2">
                4.8 <span className="text-black/60">(72 reseñas)</span>
              </span>
            </div>
              ...
              <div>
                ...
                <InputGroup className="bg-[#F0F0F0]">
                  <InputGroup.Input
                    type="text"
                    name="profile-link"
                    placeholder="https://www.facebook.com/tu_usuario"
                    value={profileLink}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Seguidores Facebook</h3>
              <p className="text-black/70 mb-4">
                Aumenta tus seguidores en Facebook con nuestro servicio premium. Mejora la credibilidad de tu perfil y
                haz que tu contenido llegue a más personas gracias al algoritmo.
              </p>
              ...
              <div className="border border-blue-500/20 rounded-xl p-5 bg-blue-500/5">
                <ul className="space-y-3 text-black/70">
                  <li className="flex items-start">
                    ...
                    <span>Mayor credibilidad para tu perfil o página</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
